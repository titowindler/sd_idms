...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        $get_customer_id = $_GET['cusID'];

        $get_delivery = $_GET['view'];

        $sqlFetch = "SELECT * FROM delivery WHERE delivery_id = '$get_delivery' ";
        ...
        <div class="content mt-3">
            ...
            <a href="view_sales.php" type="submit" class="btn btn-danger" name="submit">CANCEL</a>          
                </div>
            </div>
        </form>
    </div>
